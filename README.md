...
> Veja o exemplo de arquivo de configurações de ambiente <kbd>[.env.local.exemple.txt](./env.local.example)</kbd> para se orientar melhor sobre quais chaves devem ser configuradas para o ambiente.
